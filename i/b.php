...
?>
    <tr>
        ...
        <td><img src="images/<?php echo $data ['p_id'] ; ?>.<?php echo $data['p_ext'];?> "width="80" align="center"><a href="delete_province.php?id=<?php echo $data['r_id'];?>"".jpg" width="140"></td> $data['p_id'];?>
<?php } ?>
</table>
