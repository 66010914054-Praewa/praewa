...
<head>
    ...
    <title>หน้าหลักแอดมิน - แพรวา</title>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            ...
            <footer class="pt-5 my-5 text-muted border-top text-center">
                แพรวา ชาวดอน (แพร)&middot; &copy; 2026 Admin Management System
            </footer>
        </main>
    </div>
</div>
...
</html>r/Downloads/h/product.php"><li>จัดการสินค้า</li></a>
