...
<body>
<h1>ฟอร์มรับข้อมูล - 66010914054 แพรวา ชาวดอน (แพร)</h1>
...
ที่อยู่<br>่<textarea name="address"cols="40" rows="4"></textarea><br>
...
<button type="submit" name="Submit">สมัครสมาชิก
...
<button type="botton" onMouseOver="alert('Hi')">Hello</button>
